...
def run_compute_entropy(logits: torch.Tensor) -> torch.Tensor:
    ...
    return sft.compute_entropy(logits)
...
def run_compute_naive_policy_gradient_loss(
    ...
    """
    return rl.compute_naive_policy_gradient_loss(raw_rewards_or_advantages, policy_log_probs)
...
def run_compute_grpo_clip_loss(
    ...
    """
    return rl.compute_grpo_clip_loss(advantages, policy_log_probs, old_log_probs, cliprange)
...
def run_compute_policy_gradient_loss(
    ...
    """
    return rl.compute_policy_gradient_loss(
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    """
    return rl.masked_mean(tensor, mask, dim)
...
def run_sft_microbatch_train_step(
    ...
    """
    return sft.sft_microbatch_train_step(
        policy_log_probs,
        response_mask,
...
def run_masked_normalize(
    ...
    """
    return sft.masked_normalize(tensor, mask, normalize_constant, dim)
